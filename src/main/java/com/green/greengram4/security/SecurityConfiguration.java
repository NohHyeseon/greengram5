...
import com.green.greengram4.security.auth2.CustomOAuth2UserService;
import com.green.greengram4.security.auth2.OAuth2AuthenticationFailureHandler;
import com.green.greengram4.security.auth2.OAuth2AuthenticationRequestBasedOnCookieRepository;
import com.green.greengram4.security.auth2.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfiguration {
    ...
    private final OAuth2AuthenticationFailureHandler oAuth2AuthenticationFailureHandlerll;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                ...
                .oauth2Login(oauth2 -> oauth2.authorizationEndpoint(auth ->
                                ...
                                .failureHandler(oAuth2AuthenticationFailureHandlerll)
                )
                .build();
    }
